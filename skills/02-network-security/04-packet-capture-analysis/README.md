...
**A <a href="https://github.com/jihedbfr-art">JihedAiLabs</a> project** — Use when you need to read what's actually on the wire — capturing and analysing traffic with tcpdump and Wireshark to investigate an incident, confirm a finding, or debug.
