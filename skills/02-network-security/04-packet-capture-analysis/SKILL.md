...
title_fr: "Analyse de capture de paquets"
...
description_fr: "À utiliser pour observer ce qui transite réellement sur le réseau — capturer et analyser le trafic avec tcpdump et Wireshark afin d'enquêter sur un incident, confirmer un constat ou déboguer."
