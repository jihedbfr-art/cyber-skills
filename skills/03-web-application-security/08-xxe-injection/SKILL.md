...
name: "xxe-injection"
title: "Xxe Injection"
title_fr: "Injection XXE (XML External Entity)"
...
description_fr: "À utiliser quand une application parse du XML que vous pouvez influencer — pour tester si les entités externes permettent de lire des fichiers, d'atteindre des services internes, ou de provoquer un déni de service, et le durcissement du parseur qui l'empêche."
