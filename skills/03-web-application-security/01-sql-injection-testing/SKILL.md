...
title_fr: "Tests d'injection SQL"
...
description_fr: "À utiliser pour vérifier si un paramètre web atteint une base de données sans protection — couvre la confirmation manuelle, sqlmap, et la correction par requêtes paramétrées."
