...
title: "Writing Sigma Rules"
title_fr: "Écrire des règles Sigma"
...
description_fr: "À utiliser pour écrire une logique de détection portable — une règle Sigma qui exprime une détection une seule fois et se convertit vers le langage de requête de n'importe quel SIEM — puis l'affiner pour qu'elle se déclenche sur la bonne chose."
