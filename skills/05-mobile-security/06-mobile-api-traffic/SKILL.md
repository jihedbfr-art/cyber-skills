...
title: "Mobile Api Traffic"
title_fr: "Trafic API des applications mobiles"
...
description_fr: "À utiliser pour tester le backend auquel une application mobile parle — intercepter et tester l'API, car la vraie surface d'attaque se trouve souvent côté serveur plutôt que dans l'application sur l'appareil."
