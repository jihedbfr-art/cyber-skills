...
title: "Deep Link And Ipc Abuse"
title_fr: "Abus des deep links et de l'IPC"
...
description_fr: "À utiliser pour tester la surface de communication inter-processus d'une application mobile — deep links, schémas d'URL, intents et composants exportés que d'autres applications (ou le web) peuvent invoquer de façon malveillante."
