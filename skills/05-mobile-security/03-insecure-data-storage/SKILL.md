...
title_fr: "Stockage de données non sécurisé"
...
description_fr: "À utiliser pour vérifier comment une application mobile stocke ses données — repérer les secrets, jetons et données personnelles laissés en clair dans le stockage local, extractibles par quiconque a accès à l'appareil (ou à une sauvegarde)."
