...
**A <a href="https://github.com/jihedbfr-art">JihedAiLabs</a> project** — Use when an API returns more data than the client needs — testing whether responses leak fields the user shouldn't see, and how to filter at the server.
