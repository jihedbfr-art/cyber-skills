...
difficulty: beginner
tags: [osint, certificate-transparency, subdomains, recon, passive]
tools: [crtsh, certspotter]
---
...
# other CT sources
# certspotter, Google/Cloudflare CT search, censys certificate search
# subfinder/amass already query CT among their passive sources

# what CT reveals that DNS/wordlists miss
...
# then: resolve + probe (see subdomain-enumeration skill)
