...
description_fr: "À utiliser pour mettre en place une surveillance continue de la posture de sécurité cloud — scanner les comptes cloud par rapport à une base de référence pour détecter les mauvaises configurations, et empêcher qu'elles ne réapparaissent."
