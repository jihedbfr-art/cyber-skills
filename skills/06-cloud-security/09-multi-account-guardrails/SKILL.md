...
title_fr: "Garde-fous multi-comptes"
...
description_fr: "À utiliser pour structurer le cloud sur plusieurs comptes — en s'appuyant sur des garde-fous au niveau de l'organisation (SCP, landing zones) pour imposer une sécurité qu'aucun compte pris isolément ne peut désactiver."
