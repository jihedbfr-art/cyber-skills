...
title_fr: "Fuite de données sensibles"
...
description_fr: "À utiliser quand une application LLM pourrait révéler des données qu'elle ne devrait pas — secrets dans le prompt, données d'autres utilisateurs, données d'entraînement ou PII — et les contrôles qui maintiennent les données sensibles hors de la sortie du modèle."
