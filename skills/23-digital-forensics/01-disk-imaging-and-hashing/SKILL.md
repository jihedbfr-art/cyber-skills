...
tags: [forensics, imaging, acquisition, chain-of-custody, integrity]
tools: [dd, dc3dd, ewfacquire, guymager]
---
...
```bash
# always through a write blocker on the source

# E01 (forensic format: metadata + hashes + compression)
ewfacquire /dev/sdX
guymager                      # GUI, E01/raw, hashes automatically

# raw image with hashing + log
dc3dd if=/dev/sdX of=evidence.img hash=sha256 log=acquire.log

# integrity proof: these must match
sha256sum /dev/sdX
