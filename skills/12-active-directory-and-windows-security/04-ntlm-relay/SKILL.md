...
difficulty: advanced
tags: [active-directory, ntlm, relay, mitm, windows]
tools: [impacket, responder, mitm6]
---
...
# high-value: coerce a DC/machine account, then relay it
```
