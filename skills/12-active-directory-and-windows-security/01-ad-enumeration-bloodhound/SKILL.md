...
title_fr: "Énumération AD avec BloodHound"
...
description_fr: "À utiliser une fois un point d'ancrage obtenu dans le domaine, pour cartographier les chemins d'attaque Active Directory : collecte des données avec SharpHound, analyse dans BloodHound, et corrections à apporter."
