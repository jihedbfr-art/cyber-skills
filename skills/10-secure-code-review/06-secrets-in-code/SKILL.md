...
description_fr: "À utiliser lors de la revue (ou du balayage) d'une base de code à la recherche d'identifiants, de clés et de jetons codés en dur — pour les détecter, évaluer leur gravité et composer avec le fait que git s'en souvient."
