...
title_fr: "Conditions de compétition (race conditions)"
...
description_fr: "À utiliser lors de la revue de code pour les bugs de type TOCTOU et de concurrence à impact sécuritaire — la double dépense, la vérification devenue obsolète avant son utilisation, l'état partagé corrompu par deux requêtes simultanées."
