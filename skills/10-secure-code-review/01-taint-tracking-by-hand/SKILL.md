...
tags: [code-review, taint-analysis, injection, methodology]
tools: [grep, ripgrep, semgrep]
---
...
# then, for each hit: trace the argument back to its origin, look for a sanitiser
```
