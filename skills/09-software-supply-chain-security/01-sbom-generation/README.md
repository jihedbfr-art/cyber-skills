...
**A <a href="https://github.com/jihedbfr-art">JihedAiLabs</a> project** — Use when you need a complete inventory of what's inside a build — every dependency and its version — as an SBOM you can scan, track, and hand to auditors.
