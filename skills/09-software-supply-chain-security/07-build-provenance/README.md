...
**A <a href="https://github.com/jihedbfr-art">JihedAiLabs</a> project** — Use when attesting where and how software was built — generating build provenance so consumers can verify an artifact came from the expected source and pipeline, uncompromised.
