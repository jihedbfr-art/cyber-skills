...
**A <a href="https://github.com/jihedbfr-art">JihedAiLabs</a> project** — Use when defending against typosquatted and malicious lookalike packages — catching the malicious package with a name close to a popular one before a typo pulls it into your build.
