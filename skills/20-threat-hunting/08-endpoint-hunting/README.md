...
**A <a href="https://github.com/jihedbfr-art">JihedAiLabs</a> project** — Use when hunting on endpoint telemetry — the process, persistence, and injection patterns that reveal compromise on hosts, using the richest data source available to a hunter.
