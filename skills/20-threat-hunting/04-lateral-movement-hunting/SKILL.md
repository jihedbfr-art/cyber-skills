...
title_fr: "Chasse aux mouvements latéraux"
...
description_fr: "À utiliser pour traquer un attaquant se déplaçant d'une machine à l'autre : les schémas d'authentification, l'exécution distante et les anomalies d'accès qui trahissent un mouvement latéral sur le réseau."
