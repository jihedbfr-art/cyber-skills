...
**A <a href="https://github.com/jihedbfr-art">JihedAiLabs</a> project** — Use when you want to stop credentials from being committed or built into artifacts — wiring secret scanning into pre-commit and CI so leaks are caught before they ship.
