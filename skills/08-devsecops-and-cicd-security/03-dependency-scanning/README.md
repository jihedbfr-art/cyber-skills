...
**A <a href="https://github.com/jihedbfr-art">JihedAiLabs</a> project** — Use when scanning project dependencies for known vulnerabilities in CI — catching vulnerable third-party packages before they ship, and telling exploitable from merely-flagged.
