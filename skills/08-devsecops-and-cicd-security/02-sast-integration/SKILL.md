...
description_fr: "À utiliser pour intégrer l'analyse statique de sécurité (SAST) dans le pipeline — afin de détecter les vulnérabilités du code à chaque build sans noyer les développeurs sous les faux positifs."
