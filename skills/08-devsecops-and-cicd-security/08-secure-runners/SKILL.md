...
title_fr: "Sécurisation des runners"
...
description_fr: "À utiliser pour sécuriser les runners de build CI/CD — en particulier les runners auto-hébergés qui conservent un état persistant et exécutent du code non fiable, afin de fermer un point d'ancrage courant dans l'environnement de build."
