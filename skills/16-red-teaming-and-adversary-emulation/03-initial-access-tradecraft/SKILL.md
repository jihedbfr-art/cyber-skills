...
title: "Initial Access Tradecraft"
title_fr: "Techniques d'accès initial"
...
description_fr: "À utiliser pour planifier la phase d'accès initial d'un engagement autorisé — comment les adversaires obtiennent leur premier point d'ancrage (hameçonnage, services exposés) et, côté défense, comment le détecter et le prévenir."
