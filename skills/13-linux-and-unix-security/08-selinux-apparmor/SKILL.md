...
description_fr: "À utiliser pour appliquer le contrôle d'accès obligatoire (MAC) sous Linux — garder SELinux ou AppArmor en mode enforcing (et non désactivé) pour qu'un processus compromis reste confiné à ce qu'il est censé faire."
