...
tags: [linux, systemd, sandboxing, hardening, services]
tools: [systemd, systemd-analyze]
---
...
```bash
# measure exposure (0=safe, 10=exposed)
systemd-analyze security                 # rank all services
systemd-analyze security nginx.service   # detailed checklist for one

# edit a drop-in override (doesn't touch the vendor unit)
systemctl edit myservice.service

# high-value [Service] directives
