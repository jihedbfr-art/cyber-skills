...
This repository documents security procedures for defenders. Some entries describe offensive techniques — reconnaissance, exploitation, lateral movement — because you cannot detect or defend against what you do not understand. That content is deliberate and is not a vulnerability report.

What is worth reporting: a command or script in a skill that is unsafe as written (destructive without warning, exfiltrating where it claims not to, or leaking credentials), or guidance that would leave a reader materially less secure if followed.
